    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img
              :src="detail.imgUrl || detail.defaultImg"
              alt=""
          ...
          <li>
            <p>
              {{ detail.skuName || detail.title }}
            </p>
            <h4>7天无理由退货</h4>
          </li>
          <li>
            <h3>￥{{ detail.skuPrice }}</h3>
          </li>
...
export default {
  ...
  computed: {
    ...
    detailArrayList() {
      return this.$store.state.trade.orderInfo.detailArrayList;
    },
    orderInfo() {
