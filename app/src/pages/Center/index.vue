...
export default {
  ...
  mounted() {
    this.$store.dispatch("getOrders", this.pageNo);
  },
  computed: {
    total() {
      return this.$store.state.center.orders.total;
    },
    orders() {
      return this.$store.state.center.orders.ordersList;
    },
  },
  methods: {
    getPageNo(pageNo) {
